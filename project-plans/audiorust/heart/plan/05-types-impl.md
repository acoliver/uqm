...
All REQ-CROSS-CONST-*, REQ-CROSS-ERROR-*, REQ-CROSS-GENERAL-01/04/05 requirements fully implemented.
...
- `rust/src/sound/types.rs` — Complete all implementations
  ...
  - marker: `@requirement REQ-CROSS-CONST-01..08, REQ-CROSS-ERROR-01..03, REQ-CROSS-GENERAL-01,04,05`
