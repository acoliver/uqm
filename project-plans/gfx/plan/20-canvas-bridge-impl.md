# Phase 20: Canvas FFI Bridge — Implementation

## Phase ID
`PLAN-20260223-GFX-FULL-PORT.P20`

## Prerequisites
- Required: Phase P19a (Canvas TDD Verification) completed
...
After this phase, the DCQ flush handler (P17) can dispatch draw commands
...
This requires updating `dcq_ffi.rs` to use `SurfaceCanvas` for the current
screen surface during flush. Add this wiring if not already present.
