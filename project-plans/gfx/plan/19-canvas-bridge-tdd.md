...
> Canonical: Phase P19 = DCQ Bridge — TDD (Slice C)


# Phase 19: DCQ FFI Bridge — TDD

## Phase ID
`PLAN-20260223-GFX-FULL-PORT.P19`

## Prerequisites
- Required: Phase P18a (DCQ Stub Verification) completed
...
- Flush→Canvas tests use synthetic `TestSurface` from canvas_ffi test helpers
...
- [ ] Flush→Canvas integration tests verify actual pixel output
