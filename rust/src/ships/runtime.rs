...
mod tests {
    ...
    fn collision_planet_uses_hit_points() {
        let mut element0 = ElementState {
            crew_level: 20, // hit_points == crew_level via union
            ..ElementState::default()
        };
        let element1 = ElementState {
            mass_points: 200, // GRAVITY_MASS: > MAX_SHIP_MASS * 10
            state_flags: 0,   // not FINITE_LIFE
            ..ElementState::default()
        };
    ...
    fn collision_planet_damage_min_one() {
        let mut element0 = ElementState {
            crew_level: 2, // hit_points = 2, >> 2 = 0, but min 1
            ..ElementState::default()
        };
        let element1 = ElementState {
            mass_points: 200,
