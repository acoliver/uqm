...
## Phase ID
`PLAN-20260314-GRAPHICS.P12`

## Prerequisites
- Required: Phase P11 completed
- Verify: All integration tests pass
- Verify: Project builds with USE_RUST_GFX enabled
- Expected: All planned gap closures (G1-G17) implemented and unit/integration tested
...
12. Verify input remains responsive after any reinit-triggering flow that is safely exercisable
...
- [ ] Event-pump lifecycle/forwarding verified across init, reinit, and uninit with explicit evidence
...
Create: `project-plans/20260311/graphics/.completed/P12.md`

Contents:
- phase ID: PLAN-20260314-GRAPHICS.P12
- timestamp
- full test output
- build output
