...
/* Defined if using Rust bridge (Phase 3) */
#define USE_RUST_BRIDGE

/* Defined if using Rust file I/O (Phase 3) */
#define USE_RUST_FILE

/* Defined if using Rust clock (Phase 3) */
#define USE_RUST_CLOCK

/* Defined if using Rust UIO (Phase 3) */
#define USE_RUST_UIO
...
/* Defined if using Rust comm */
#define USE_RUST_COMM
...
/* Defined if using Rust resources */
#define USE_RUST_RESOURCE

/* Defined if using Rust MOD decoder */
#define USE_RUST_MOD
